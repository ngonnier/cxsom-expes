...
if __name__ == "__main__":
    ...
    with cx.variable.Realize(varpath('I1'), cx.typing.Scalar(),2,100000) as x:
        with cx.variable.Realize(varpath('I2'), cx.typing.make('Scalar'),2,100000) as y:
                with cx.variable.Realize(varpath('U'), cx.typing.make('Scalar'),2,100000) as u:
    ...
    with cx.variable.Realize(varpath_test('I1'), cx.typing.make('Scalar'),2,100000) as x:
        with cx.variable.Realize(varpath_test('I2'), cx.typing.make('Scalar'),2,100000) as y:
                with cx.variable.Realize(varpath_test('U'), cx.typing.make('Scalar'),2,100000) as u:
